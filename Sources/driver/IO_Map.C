...
*********************************************************************************
*/
#ifndef  _HCS12_IOMAP_C_
#define  _HCS12_IOMAP_C_
...
***********************************************************************
*/ 
volatile CAN1CTL0STR	 _CAN1CTL0;
volatile CAN1CTL1STR   _CAN1CTL1;
volatile CAN1BTR0STR   _CAN1BTR0;
volatile CAN1BTR1STR   _CAN1BTR1;
volatile CAN1RFLGSTR   _CAN1RFLG;
volatile CAN1RIERSTR   _CAN1RIER;
volatile CAN1TFLGSTR   _CAN1TFLG;
volatile CAN1TIERSTR   _CAN1TIER;
volatile CAN1TARQSTR   _CAN1TARQ;
volatile CAN1TAAKSTR   _CAN1TAAK;
volatile CAN1TBSELSTR  _CAN1TBSEL;
volatile CAN1IDACSTR   _CAN1IDAC;
volatile CAN1RXERRSTR  _CAN1RXERR;
volatile CAN1TXERRSTR  _CAN1TXERR;
volatile CAN1IDAR0STR  _CAN1IDAR0;
volatile CAN1IDAR1STR  _CAN1IDAR1;
volatile CAN1IDAR2STR  _CAN1IDAR2;
volatile CAN1IDAR3STR  _CAN1IDAR3;
volatile CAN1IDMR0STR  _CAN1IDMR0;
volatile CAN1IDMR1STR  _CAN1IDMR1;
volatile CAN1IDMR2STR  _CAN1IDMR2;
volatile CAN1IDMR3STR  _CAN1IDMR3;
volatile CAN1IDAR4STR  _CAN1IDAR4;
volatile CAN1IDAR5STR  _CAN1IDAR5;
volatile CAN1IDAR6STR  _CAN1IDAR6;
volatile CAN1IDAR7STR  _CAN1IDAR7;
volatile CAN1IDMR4STR  _CAN1IDMR4;
volatile CAN1IDMR5STR  _CAN1IDMR5;
volatile CAN1IDMR6STR  _CAN1IDMR6;
volatile CAN1IDMR7STR  _CAN1IDMR7;

volatile CAN1RXIDR0STR _CAN1RXIDR0;
volatile CAN1RXIDR1STR _CAN1RXIDR1;
volatile CAN1RXIDR2STR _CAN1RXIDR2;
volatile CAN1RXIDR3STR _CAN1RXIDR3;

volatile CAN1RXDSR0STR _CAN1RXDSR0;
volatile CAN1RXDSR1STR _CAN1RXDSR1;
volatile CAN1RXDSR2STR _CAN1RXDSR2;
volatile CAN1RXDSR3STR _CAN1RXDSR3;
volatile CAN1RXDSR4STR _CAN1RXDSR4;
volatile CAN1RXDSR5STR _CAN1RXDSR5;
volatile CAN1RXDSR6STR _CAN1RXDSR6;
volatile CAN1RXDSR7STR _CAN1RXDSR7;
volatile CAN1RXDLRSTR  _CAN1RXDLR;

volatile CAN1TXIDR0STR  _CAN1TXIDR0;
volatile CAN1TXIDR1STR  _CAN1TXIDR1;
volatile CAN1TXIDR2STR  _CAN1TXIDR2;
volatile CAN1TXIDR3STR  _CAN1TXIDR3;

volatile CAN1TXDSR0STR  _CAN1TXDSR0;
volatile CAN1TXDSR1STR  _CAN1TXDSR1;
volatile CAN1TXDSR2STR  _CAN1TXDSR2;
volatile CAN1TXDSR3STR  _CAN1TXDSR3;
volatile CAN1TXDSR4STR  _CAN1TXDSR4;
volatile CAN1TXDSR5STR  _CAN1TXDSR5;
volatile CAN1TXDSR6STR  _CAN1TXDSR6;
volatile CAN1TXDSR7STR  _CAN1TXDSR7;

volatile CAN1TXDLRSTR   _CAN1TXDLR;
volatile CAN1TXTBPRSTR  _CAN1TXTBPR;
...
***********************************************************************
*/
volatile CAN2CTL0STR	 _CAN2CTL0;
volatile CAN2CTL1STR   _CAN2CTL1;
volatile CAN2BTR0STR   _CAN2BTR0;
volatile CAN2BTR1STR   _CAN2BTR1;
volatile CAN2RFLGSTR   _CAN2RFLG;
volatile CAN2RIERSTR   _CAN2RIER;
volatile CAN2TFLGSTR   _CAN2TFLG;
volatile CAN2TIERSTR   _CAN2TIER;
volatile CAN2TARQSTR   _CAN2TARQ;
volatile CAN2TAAKSTR   _CAN2TAAK;
volatile CAN2TBSELSTR  _CAN2TBSEL;
volatile CAN2IDACSTR   _CAN2IDAC;
volatile CAN2RXERRSTR  _CAN2RXERR;
volatile CAN2TXERRSTR  _CAN2TXERR;
volatile CAN2IDAR0STR  _CAN2IDAR0;
volatile CAN2IDAR1STR  _CAN2IDAR1;
volatile CAN2IDAR2STR  _CAN2IDAR2;
volatile CAN2IDAR3STR  _CAN2IDAR3;
volatile CAN2IDMR0STR  _CAN2IDMR0;
volatile CAN2IDMR1STR  _CAN2IDMR1;
volatile CAN2IDMR2STR  _CAN2IDMR2;
volatile CAN2IDMR3STR  _CAN2IDMR3;
volatile CAN2IDAR4STR  _CAN2IDAR4;
volatile CAN2IDAR5STR  _CAN2IDAR5;
volatile CAN2IDAR6STR  _CAN2IDAR6;
volatile CAN2IDAR7STR  _CAN2IDAR7;
volatile CAN2IDMR4STR  _CAN2IDMR4;
volatile CAN2IDMR5STR  _CAN2IDMR5;
volatile CAN2IDMR6STR  _CAN2IDMR6;
volatile CAN2IDMR7STR  _CAN2IDMR7;

volatile CAN2RXIDR0STR _CAN2RXIDR0;
volatile CAN2RXIDR1STR _CAN2RXIDR1;
volatile CAN2RXIDR2STR _CAN2RXIDR2;
volatile CAN2RXIDR3STR _CAN2RXIDR3;

volatile CAN2RXDSR0STR _CAN2RXDSR0;
volatile CAN2RXDSR1STR _CAN2RXDSR1;
volatile CAN2RXDSR2STR _CAN2RXDSR2;
volatile CAN2RXDSR3STR _CAN2RXDSR3;
volatile CAN2RXDSR4STR _CAN2RXDSR4;
volatile CAN2RXDSR5STR _CAN2RXDSR5;
volatile CAN2RXDSR6STR _CAN2RXDSR6;
volatile CAN2RXDSR7STR _CAN2RXDSR7;
volatile CAN2RXDLRSTR  _CAN2RXDLR;

volatile CAN2TXIDR0STR  _CAN2TXIDR0;
volatile CAN2TXIDR1STR  _CAN2TXIDR1;
volatile CAN2TXIDR2STR  _CAN2TXIDR2;
volatile CAN2TXIDR3STR  _CAN2TXIDR3;

volatile CAN2TXDSR0STR  _CAN2TXDSR0;
volatile CAN2TXDSR1STR  _CAN2TXDSR1;
volatile CAN2TXDSR2STR  _CAN2TXDSR2;
volatile CAN2TXDSR3STR  _CAN2TXDSR3;
volatile CAN2TXDSR4STR  _CAN2TXDSR4;
volatile CAN2TXDSR5STR  _CAN2TXDSR5;
volatile CAN2TXDSR6STR  _CAN2TXDSR6;
volatile CAN2TXDSR7STR  _CAN2TXDSR7;

volatile CAN2TXDLRSTR   _CAN2TXDLR;
volatile CAN2TXTBPRSTR  _CAN2TXTBPR;
...
***********************************************************************
*/ 
volatile CAN3CTL0STR	 _CAN3CTL0;
volatile CAN3CTL1STR   _CAN3CTL1;
volatile CAN3BTR0STR   _CAN3BTR0;
volatile CAN3BTR1STR   _CAN3BTR1;
volatile CAN3RFLGSTR   _CAN3RFLG;
volatile CAN3RIERSTR   _CAN3RIER;
volatile CAN3TFLGSTR   _CAN3TFLG;
volatile CAN3TIERSTR   _CAN3TIER;
volatile CAN3TARQSTR   _CAN3TARQ;
volatile CAN3TAAKSTR   _CAN3TAAK;
volatile CAN3TBSELSTR  _CAN3TBSEL;
volatile CAN3IDACSTR   _CAN3IDAC;
volatile CAN3RXERRSTR  _CAN3RXERR;
volatile CAN3TXERRSTR  _CAN3TXERR;

volatile CAN3IDAR0STR  _CAN3IDAR0;
volatile CAN3IDAR1STR  _CAN3IDAR1;
volatile CAN3IDAR2STR  _CAN3IDAR2;
volatile CAN3IDAR3STR  _CAN3IDAR3;
volatile CAN3IDAR4STR  _CAN3IDAR4;
volatile CAN3IDAR5STR  _CAN3IDAR5;
volatile CAN3IDAR6STR  _CAN3IDAR6;
volatile CAN3IDAR7STR  _CAN3IDAR7;


volatile CAN3IDMR0STR  _CAN3IDMR0;
volatile CAN3IDMR1STR  _CAN3IDMR1;
volatile CAN3IDMR2STR  _CAN3IDMR2;
volatile CAN3IDMR3STR  _CAN3IDMR3;
volatile CAN3IDMR4STR  _CAN3IDMR4;
volatile CAN3IDMR5STR  _CAN3IDMR5;
volatile CAN3IDMR6STR  _CAN3IDMR6;
volatile CAN3IDMR7STR  _CAN3IDMR7;

volatile CAN3RXIDR0STR _CAN3RXIDR0;
volatile CAN3RXIDR1STR _CAN3RXIDR1;
volatile CAN3RXIDR2STR _CAN3RXIDR2;
volatile CAN3RXIDR3STR _CAN3RXIDR3;

volatile CAN3RXDSR0STR _CAN3RXDSR0;
volatile CAN3RXDSR1STR _CAN3RXDSR1;
volatile CAN3RXDSR2STR _CAN3RXDSR2;
volatile CAN3RXDSR3STR _CAN3RXDSR3;
volatile CAN3RXDSR4STR _CAN3RXDSR4;
volatile CAN3RXDSR5STR _CAN3RXDSR5;
volatile CAN3RXDSR6STR _CAN3RXDSR6;
volatile CAN3RXDSR7STR _CAN3RXDSR7;
volatile CAN3RXDLRSTR  _CAN3RXDLR;

volatile CAN3TXIDR0STR  _CAN3TXIDR0;
volatile CAN3TXIDR1STR  _CAN3TXIDR1;
volatile CAN3TXIDR2STR  _CAN3TXIDR2;
volatile CAN3TXIDR3STR  _CAN3TXIDR3;

volatile CAN3TXDSR0STR  _CAN3TXDSR0;
volatile CAN3TXDSR1STR  _CAN3TXDSR1;
volatile CAN3TXDSR2STR  _CAN3TXDSR2;
volatile CAN3TXDSR3STR  _CAN3TXDSR3;
volatile CAN3TXDSR4STR  _CAN3TXDSR4;
volatile CAN3TXDSR5STR  _CAN3TXDSR5;
volatile CAN3TXDSR6STR  _CAN3TXDSR6;
volatile CAN3TXDSR7STR  _CAN3TXDSR7;

volatile CAN3TXDLRSTR   _CAN3TXDLR;
volatile CAN3TXTBPRSTR  _CAN3TXTBPR;
...
***********************************************************************
*/ 
volatile CAN4CTL0STR	 _CAN4CTL0;
volatile CAN4CTL1STR   _CAN4CTL1;
volatile CAN4BTR0STR   _CAN4BTR0;
volatile CAN4BTR1STR   _CAN4BTR1;
volatile CAN4RFLGSTR   _CAN4RFLG;
volatile CAN4RIERSTR   _CAN4RIER;
volatile CAN4TFLGSTR   _CAN4TFLG;
volatile CAN4TIERSTR   _CAN4TIER;
volatile CAN4TARQSTR   _CAN4TARQ;
volatile CAN4TAAKSTR   _CAN4TAAK;
volatile CAN4TBSELSTR  _CAN4TBSEL;
volatile CAN4IDACSTR   _CAN4IDAC;
volatile CAN4RXERRSTR  _CAN4RXERR;
volatile CAN4TXERRSTR  _CAN4TXERR;
volatile CAN4IDAR0STR  _CAN4IDAR0;
volatile CAN4IDAR1STR  _CAN4IDAR1;
volatile CAN4IDAR2STR  _CAN4IDAR2;
volatile CAN4IDAR3STR  _CAN4IDAR3;
volatile CAN4IDMR0STR  _CAN4IDMR0;
volatile CAN4IDMR1STR  _CAN4IDMR1;
volatile CAN4IDMR2STR  _CAN4IDMR2;
volatile CAN4IDMR3STR  _CAN4IDMR3;
volatile CAN4IDAR4STR  _CAN4IDAR4;
volatile CAN4IDAR5STR  _CAN4IDAR5;
volatile CAN4IDAR6STR  _CAN4IDAR6;
volatile CAN4IDAR7STR  _CAN4IDAR7;
volatile CAN4IDMR4STR  _CAN4IDMR4;
volatile CAN4IDMR5STR  _CAN4IDMR5;
volatile CAN4IDMR6STR  _CAN4IDMR6;
volatile CAN4IDMR7STR  _CAN4IDMR7;

volatile CAN4RXIDR0STR _CAN4RXIDR0;
volatile CAN4RXIDR1STR _CAN4RXIDR1;
volatile CAN4RXIDR2STR _CAN4RXIDR2;
volatile CAN4RXIDR3STR _CAN4RXIDR3;

volatile CAN4RXDSR0STR _CAN4RXDSR0;
volatile CAN4RXDSR1STR _CAN4RXDSR1;
volatile CAN4RXDSR2STR _CAN4RXDSR2;
volatile CAN4RXDSR3STR _CAN4RXDSR3;
volatile CAN4RXDSR4STR _CAN4RXDSR4;
volatile CAN4RXDSR5STR _CAN4RXDSR5;
volatile CAN4RXDSR6STR _CAN4RXDSR6;
volatile CAN4RXDSR7STR _CAN4RXDSR7;
volatile CAN4RXDLRSTR  _CAN4RXDLR;

volatile CAN4TXIDR0STR  _CAN4TXIDR0;
volatile CAN4TXIDR1STR  _CAN4TXIDR1;
volatile CAN4TXIDR2STR  _CAN4TXIDR2;
volatile CAN4TXIDR3STR  _CAN4TXIDR3;

volatile CAN4TXDSR0STR  _CAN4TXDSR0;
volatile CAN4TXDSR1STR  _CAN4TXDSR1;
volatile CAN4TXDSR2STR  _CAN4TXDSR2;
volatile CAN4TXDSR3STR  _CAN4TXDSR3;
volatile CAN4TXDSR4STR  _CAN4TXDSR4;
volatile CAN4TXDSR5STR  _CAN4TXDSR5;
volatile CAN4TXDSR6STR  _CAN4TXDSR6;
volatile CAN4TXDSR7STR  _CAN4TXDSR7;

volatile CAN4TXDLRSTR   _CAN4TXDLR;
volatile CAN4TXTBPRSTR  _CAN4TXTBPR;
